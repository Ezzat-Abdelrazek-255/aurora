...
export function FilterBar() {
  ...
  return (
    <div
      ...
      className="pointer-events-auto fixed right-[112px] top-4 z-40 hidden min-h-[40px] items-center gap-5 text-[14px] mix-blend-difference text-white md:flex md:gap-6 md:text-[15px]"
